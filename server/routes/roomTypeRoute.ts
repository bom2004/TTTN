...
roomTypeRouter.post('/', upload.array('images', 10), addRoomType); // POST /api/room-types
roomTypeRouter.get('/', getAllRoomTypes); // GET /api/room-types
roomTypeRouter.put('/:id', upload.array('images', 10), updateRoomType); // PUT /api/room-types/:id
