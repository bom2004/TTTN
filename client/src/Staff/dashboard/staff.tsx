...
const StaffManager: React.FC = () => {
    ...
    // Filter only staff members for Manager: receptionist & accountant
    const staffMembers = allUsers.filter(u => ['receptionist', 'accountant'].includes(u.role));
    ...
    const getRoleLabel = (role: string): string => {
        return role === 'receptionist' ? 'Lễ tân' : 'Kế toán';
    };

    const getRoleColor = (role: string): string => {
        return role === 'receptionist' ? 'text-amber-600 bg-amber-50' : 'text-indigo-600 bg-indigo-50';
    };
        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="max-w-[1600px] mx-auto">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm text-gray-500 mt-1">Giám sát hoạt động của Lễ tân và Kế toán</p>
                </div>
